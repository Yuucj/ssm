...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content"> <!--订单信息-->
            ...
            <form action="${pageContext.request.contextPath}/orders/updatePayType">
            <!--联系人信息/--> <!--费用信息--> <c:if test="${orders.orderStatus==1}">
                <div class="panel panel-default">
                    ...
                    <input type="hidden" name="id" value="${orders.id}">
                        ...
                        <div class="col-md-4 data text">在线支付-<select name="payType">
                            <option value="0" ${orders.payType ==0?'selected' :""}>支付宝</option>
                            <option value="1"${orders.payType ==1?'selected' :""}>微信</option>
                            <option value="2"${orders.payType ==2?'selected' :""}>其他</option>
                        </select></div>
                ...
                <div class="box-tools text-center">
                    ...
                    <button type="submit" class="btn bg-default">修改
                    </button>
                </div>
            </form>
            <!--工具栏/--> </section>
