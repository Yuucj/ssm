				...
				<div class="row data-type">
					...
					<div class="col-md-4 data">
						<div class="input-group date">
							...
							<input type="text" class="form-control pull-right"
								id="datepicker-a6" name="product.departureTime"
								 >
						</div>
					</div>
					<div class="col-md-2 title">出游人数</div>
					<div class="col-md-4 data">
						<input type="text" id="peopleCount" class="form-control" placeholder="出游人数"
							name="peopleCount"  >
					</div>
						...
						<c:forEach var="traveller" items="${orders.travellers}">
							...
							<tr>
								...
								<td><input type="text" size="15"
									value="${traveller.credentialsTypeStr}"  ></td>
								<td><input type="text" size="28"
									value="${traveller.credentialsNum }"  ></td>
							</tr>
						</c:forEach>
