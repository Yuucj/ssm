                ...
                <c:forEach items="${pageInfo.list}" var="user">
                  <tr>
                    ...
                    <td class="text-center">
                      <a href="${pageContext.request.contextPath}/user/findById?id=${user.id}&next=user-show"
                         class="btn bg-olive btn-xs">详情</a>
                      <a href="${pageContext.request.contextPath}/user/findById?id=${user.id}&next=user-update"
                         class="btn bg-olive btn-xs">编辑</a>
                      <a href="${pageContext.request.contextPath}/user/findByIdAndAllRole?id=${user.id}"
...
<script>
    ...
    $(function () {
        $("#rows").change(function () {
            ...
            location.href = "${pageContext.request.contextPath}/user/findAll?page=1&rows=" + rows + "&condition=${condition}"
        })

    });

    function doSearch() {
        location.href = "${pageContext.request.contextPath}/user/findAll?condition=" + $("#condition").val();
    }
    ...
    function del() {
        ...
        if (flag) {
            if (confirm("确定要删除吗?")) {
                $.post("${pageContext.request.contextPath}/user/delete", $("#form").serialize(), function () {
                    location.reload();
                })
            }
        } else {
